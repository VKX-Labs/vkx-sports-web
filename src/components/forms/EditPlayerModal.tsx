...
export default function EditPlayerModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-sm">
      <div className="bg-brand-dark border border-slate-850 rounded-2xl w-full max-w-md mx-auto max-h-[90vh] overflow-y-auto shadow-2xl flex flex-col scrollbar-none">
